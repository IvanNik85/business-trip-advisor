     ...
     render() {
        ...
        return (
            <div id="fullWidth">
              ...
              temperature={this.state.weatherData.currently.temperature}/></div>
                </div>        
